  ...
  <el-table
    ...
    <el-table-column v-for="(column, index) in columns" :key="column.dataIndex"
      ...
      <template slot-scope="scope">
        ...
        <el-button type="text" v-if="toggleIconShow(index,scope.row)" @click="toggle(scope.$index)">
    ...
    <el-table-column label="操作" v-if="treeType === 'normal'" width="360">
      <template slot-scope="scope">
        ...
        <el-button type="success" class="el-button el-button--success el-button--small">
